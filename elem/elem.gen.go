...
// The HTML <multicol> element was an experimental element designed to allow
...
func Multicol(markup ...vecty.MarkupOrComponentOrHTML) *vecty.HTML {
	return vecty.Tag("multicol", markup...)
}
